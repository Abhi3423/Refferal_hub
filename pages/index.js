            ...
            <div className="row">
              <div className="column align-center">
                <h1 className="test-giga text-center">
                  Unlock the power of referrals with Referral Hub.
                </h1>
                <p className="text-lg text-center max-w-lg">
                  Find the best candidates for your job openings and give
            ...
            <div className="row">
              <div className="column align-center">
                ...
                <p className="text-lg text-center max-w-md">
                  ...
                  to refer and boost your companys hiring success.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row items-center v-t">
              <div className="column align-left p-2xl">
                ...
                <h2 className="max-w-lg">
                  Bring your company to life with captivating landing page
                  designs.
                </h2>
                <p className="text-lg">
                  Make a lasting impression with stunning landing page designs
                  that bring your company to life. Our animations and
                  AI-generated images will captivate your audience and leave a
                  lasting impact. Stand out from the competition and attract top
                  talent with our visually appealing landing pages.
                </p>
              </div>
            ...
            <div className="row reverse items-center v-t">
              <div className="column align-left p-2xl">
                ...
                <p className="text-lg">
                  ...
                  Hubs intuitive UI/UX and stunning glassmorphism effects,
                  finding the ideal candidate for your job opening has never
                  been easier. Say hello to effortless hiring and start building
            ...
            <div className="row items-center v-t">
              <div className="column align-left p-2xl">
                ...
                <p className="text-lg">
                  Simplify the referral process with Referral Hubs easy-to-use
                  login buttons for referral managers and candidates. Find the
                  best candidates for job openings and streamline the referral
          ...
          <div className="container mt-2xl mb-2xl">
            ...
            <div className="border-t mt-xl">
              <div className="row mt-xl v-l">
                <div className="column align-left">
                  <div className="muted text-sm">©copyright2023</div>
                </div>
                <div className="column align-right">
