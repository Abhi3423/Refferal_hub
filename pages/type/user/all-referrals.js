    ...
    <>
      <Layout>
        <div className="text-gray-600">
          <div className="px-5 mx-auto flex justify-center">
            {!isLoading ? (
                    ...
                    <div
                      ...
                      <div className="md:flex-grow ">
                        ...
                        <h4 className=" pb-4 font-normal">
                          {item?.refForm?.company_name}
                        </h4>
                        <div className="flex pb-2 items-center ">
                          <svg
                            class="w-4 h-4 mr-4 text-gray-800"
                            aria-hidden="true"
                        ...
                        <p className="leading-relaxed mb-4">
                          {item?.refForm?.job_description}
                        </p>
                        <hr></hr>
                        <button
                          className={
                            "text-white inline-flex items-center cursor-pointer mt-4 bg-[#3d52f1] p-2  rounded" +
